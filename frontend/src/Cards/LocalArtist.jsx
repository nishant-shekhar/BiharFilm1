              ...
              <div className="p-8 lg:p-12 max-w-4xl mx-auto space-y-10">
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left pb-8 border-b border-gray-100">
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    {/* Communication Details (Moved from Overview) */}
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed max-w-2xl">
                          {focusedArtist.description ||
                            "No professional biography has been provided for this profile yet. This artist is part of the official BSFDFC talent registry."}
                        </p>
                      </div>
                      ...
                      <div className="space-y-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                          ...
                          {focusedArtist.linkedIn && (
                            <a
                              href={focusedArtist.linkedIn}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="group flex items-center p-4 bg-white border border-gray-100 rounded-xl hover:border-[#0077b5] hover:shadow-md transition-all"
                            >
                              <div className="w-12 h-12 bg-[#0077b5]/10 rounded-lg flex items-center justify-center text-[#0077b5] group-hover:bg-[#0077b5] group-hover:text-white transition-colors">
                          ...
                          {focusedArtist.instagram && (
                            <a
                              href={focusedArtist.instagram}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="group flex items-center p-4 bg-white border border-gray-100 rounded-xl hover:border-[#e4405f] hover:shadow-md transition-all"
                            >
                              <div className="w-12 h-12 bg-[#e4405f]/10 rounded-lg flex items-center justify-center text-[#e4405f] group-hover:bg-[#e4405f] group-hover:text-white transition-colors">
                          ...
                          {focusedArtist.twitter && (
                            <a
                              href={focusedArtist.twitter}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="group flex items-center p-4 bg-white border border-gray-100 rounded-xl hover:border-black hover:shadow-md transition-all"
                            >
                              <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center text-black group-hover:bg-black group-hover:text-white transition-colors">
                                <FiExternalLink className="text-xl" />
                              </div>
                              <div className="ml-4">
                                <h4 className="text-sm font-bold text-gray-900">
                          ...
                          !focusedArtist.twitter && (
                            <div className="text-center py-20 bg-gray-50/50 border border-dashed border-gray-200 rounded-3xl">
                              ...
                              <p className="text-xs text-gray-400 mt-2 px-6">
                                This artist has not connected any social media
                                profiles.
                              </p>
                            </div>
                          )}
                    ...
                    <div className="animate-in fade-in duration-500">
                      ...
                      focusedArtist.videos.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          {/* Video Mapping Placeholder - assuming videos array structure */}
